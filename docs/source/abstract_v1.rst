...
-  Familiarize yourself with the `guidelines for code
   contributions <CONTRIBUTING.rst>`__ to this project. **Note**: In
   order to participate in the development of the Hyperledger Fabric
   project, you will need an `LF account <Gerrit/lf-account.rst>`__. This
   will give you single sign-on to JIRA and Gerrit.
-  Explore the design document for the new
   `architecture <https://github.com/hyperledger/fabric/blob/master/proposals/r1/Next-Consensus-Architecture-Proposal.rst>`__
